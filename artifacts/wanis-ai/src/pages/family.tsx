...
import { Heart, ImagePlus, Loader2, Phone, Plus, Shield, Trash2, User, X } from "lucide-react"
...
/** Turn a stored objectPath into an <img src> the browser can load */
function photoSrc(objectPath: string | null | undefined): string | undefined {
  if (!objectPath) return undefined
  // Already a full http URL (legacy paste) — use as-is
  if (objectPath.startsWith("http")) return objectPath
  // objectPath is like /objects/uploads/uuid — serve via our API
...
function PhotoUploader({
  ...
  return (
    <div className="space-y-2">
      ...
      {preview ? (
        <div className="relative w-full h-36 rounded-2xl overflow-hidden bg-card border border-border">
          <img
            src={preview}
            alt="Preview"
